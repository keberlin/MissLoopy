...
def search(distance,order,id,x,y,tz,gender,age,ethnicity,height,weight,gender_choice,age_min,age_max,ethnicity_choice,height_min,height_max,weight_choice):
  ...
  for entry,d in list:
    if entry[COL_ID] == id:
      continue
    # Ignore if you have blocked them or they have blocked you
    if BlockedMutually(id, entry[COL_ID]):
      continue
    search_list.append((entry,d))
